...
{
    public class Code128Yeni : ShapeBase
    {
        #region yeni
        ...
        private List<string> EncodedData = new List<string>();
        ...
        public Code128Yeni(string mfgNumber, string productId)
        {
            this._sName = "CODE128";
            this._fWidth = 0x71;
            this._fHeight = 0x4e;
        ...
        public Code128Yeni(string countryCode, string mfgNumber, string productId)
        {
            this._sName = "CODE128";
            this._fWidth = 0x71;
            this._fHeight = 0x4e;
        ...
        public Code128Yeni(string countryCode, string mfgNumber, string productId, string checkDigit)
        {
            this._sName = "CODE128";
            this._fWidth = 0x71;
            this._fHeight = 0x4e;
        ...
        public override void Paint(Graphics g)
        {
            ...
            {
                if (Yon)
                    g.DrawRectangle(new Pen(Color.Violet, 2f),
                        new Rectangle(Location.X, Location.Y, (int)this._fWidth, (int)this._fHeight));
                else g.DrawRectangle(new Pen(Color.Violet, 2f),
                   new Rectangle(Location.X, Location.Y, (int)this._fHeight, (int)this._fWidth));
            }

            Bitmap b = new Bitmap(Encoded_Value.Length * 2, (int)this.Height);//new Bitmap(Yon ? (int)this.Width : (int)this.Height, Yon ? (int)this.Height : (int)this.Width);
            ...
            using (Graphics gg = Graphics.FromImage(b))
            {
                while ((pos * 2 + 1) < b.Width)
                {
                    ...
                    gg.DrawLine(new Pen(c, (float)2), new Point(pos * 2 + 1, 0), new Point(pos * 2 + 1, b.Height));
            ...
            using (Graphics gg = Graphics.FromImage(b))
            {
                gg.DrawImage(b, (float)0, (float)0);
                ...
                gg.FillRectangle(new SolidBrush(Color.White), new Rectangle(0, b.Height - 16, b.Width, 16));

                //draw datastring under the barcode image
                StringFormat f = new StringFormat();
                f.Alignment = StringAlignment.Center;
                gg.DrawString(this.Raw_Data, font, new SolidBrush(Color.Black), (float)(b.Width / 2), b.Height - 16, f);
            ...
            g.DrawImage(ResizeImage(b, Yon ? (int)this.Width : (int)this.Height, Yon ? (int)this.Height : (int)this.Width), Location);
        }
        ...
        public override string Text
        {
            ...
            set
            {
                ...
                Raw_Data = this.text;
                Encoded_Value = Encode_Code128();
                if (!Yon)
                    this._fHeight = Encoded_Value.Length;
                else this._fWidth = Encoded_Value.Length * 2;
            }
        }
        ...
        public float Width
        {
            ...
            set { this._fWidth = Convert.ToInt32(value); }
        }
